...
- **19 defects found and fixed**, each written up with how it was found, why the tests missed it, and a regression test that fails without the fix. One was a bug that every mocked test passed and only the real-stack smoke test caught.
